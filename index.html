...
<body id="page-top">
    ...
    <header class="masthead">
        <div class="container">
            ...
            <div class="text-center">
                <img width="220rem" height="190rem" class="rounded-circle animate-image" src="assets/profile/p3.png" alt="">
            </div>

            <br>

            <div class="masthead-subheading animateheader">Welcome To My Website!</div>
            <div class="masthead-heading text-uppercase animate-name"> I'm Mostafa Nawam</div>
            <a download class="btninfo btn-xl show-services" target="_blank" href="https://drive.google.com/file/d/11ug0ZFLW6JTYt4HYW3arYvcDoWiOxK7a/view?usp=sharing">Check CV</a>
        </div>
    </header>
    ...
    <section class="page-section" id="about" style="background-color:rgb(22, 25, 34);">
        <div class="container">
            ...
            <div class="text-center">
                ...
                <h3 id=title2 class="section-subheading ">My road to success.</h3>
            </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="img">
                        <img width="100%" height="400" id="img-about" src="assets/images/logo.jpeg" />
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="txt-about">
                    ...
                    <a class="btn btnabout js-scroll-trigger btn-about1" href="#contact">Contact Me</a>
                    <a class="btn btnabout js-scroll-trigger btn-about2" href="#portfolio">My Work</a>
                </div>
            </div>
            ...
            <br>
            <h3 class="text-center" id="title-skills" style="color:#FFD700;">My Skills</h3>
            <br>
    ...
    <section class="page-section" id="services" style="background-color:rgb(25, 29, 40);">
        <div class="container">
            ...
            <div class="test1">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase" id='serv-title'>Services</h2>
                    <h3 class="section-subheading" id='serv-subtitle'>This is what I prefer to do.</h3>
                </div>
            </div>



            <div class="row text-center row-serv" id="serv">
                <div class="col-md-4">
    ...
    <section class="page-section" id="portfolio" style="background-color:#161922;">
        <div class="container">
            ...
            <div class="test1">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase" id='title-proj'>My Projects</h2>
                    <h3 class="section-subheading " id="subtitle-proj">Some of my work.</h3>
                </div>
            </div>
            ...
            <div class="row proj-list">
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="portfolio-item">
                        ...
                        <img class="img-fluid img-projects" loading=lazy src="assets/images/proj1.jpg" alt="" />
                        <!--</a>-->
                        <div class="portfolio-caption bottom-img-proj">
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="portfolio-item">
                        ...
                        <img class="img-fluid img-projects" loading=lazy src="assets/images/proj032.png" alt="" />
                ...
                <div class="col-lg-4 col-sm-6 mb-4 ">
                    <div class="portfolio-item ">
                        <img class="img-fluid img-projects" loading=lazy src="assets/images/proj04.png" alt="" />
            ...
            <div class="row proj-list">
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="portfolio-item">
                        ...
                        <img class="img-fluid img-projects" loading=lazy src="assets/images/proj3.png" alt="" />
                ...
                <div class="col-lg-4 col-sm-6 mb-4">
                    <div class="portfolio-item">
                        ...
                        <img class="img-fluid img-projects" loading=lazy src="assets/images/4.png" alt="" />
    ...
    <section class="page-section" id="contact" style="background-color:rgb(25, 29, 40);">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase" id='title-cont'>Contact Us</h2>
                <h3 class="section-subheading " id='subtitle-cont'>For all enquiries, please email me using the form below.</h3>
            </div>
            <form id="contactForm" name="sentMessage" novalidate="novalidate" method="POST">
                <div class="row align-items-stretch mb-5" id="form-con">
                    <div class="col-md-6">
                ...
                <div class="text-center">
                    <div id="success"></div>
                    <button class="btn btnsend btn-xl text-uppercase" name="btn" id="sendMessageButton" type="button" onclick="sendmail()">Send Message</button>
                </div>
            </form>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 my-3 my-lg-0">
                    ...
                    <a class="btn btn-dark btn-social mx-2" href="https://github.com/mostafanawam"><i class="fab fa-github"></i></a>
                </div>
                    ...
                    <div class="col-lg-8">
                        <div class="modal-body">
                            ...
                            <p>
                                ...
                                <br> Moreover, this system is designed for the particular need of the company to carry out operations smoothly and effectively. The implantation of the system was done using Laravel framework.</p>
